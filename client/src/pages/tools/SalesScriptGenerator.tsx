...
export default function SalesScriptGenerator() {
  ...
  return (
    <>
      <SEO 
        title="Sales Script Generator - Create Converting Sales Scripts"
        description="Generate effective, personalized sales scripts that convert prospects into customers. Our AI-powered tool helps create natural, engaging sales conversations."
        image="/sales-script-preview.png"
      />
